...
def print_state_items(monkey_list: List[Monkey], round) -> None:
    print(f"After round {round + 1}:")
    for ii, monkey in enumerate(monkey_list):
        print(f"Monkey {ii}: {monkey}")

def print_state_insp(monkey_list: List[Monkey], round) -> None:
    print(f"After round {round + 1}:")
    for ii, monkey in enumerate(monkey_list):
        print(f"Monkey {ii}: {monkey.num_insp}")
...
def main():
    ...
    for round in range(num_rounds):
        ...
        # print_state_insp(monkey_list, round)
